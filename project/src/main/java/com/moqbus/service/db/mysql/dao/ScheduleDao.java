...
public class ScheduleDao<E extends CacheableEntity> extends CacheableDao<E> {

	static Logger LOG = Logger.getLogger(ScheduleDao.class);
	
	public ScheduleDao(Connection _conn) {
		super(_conn);
	}
	...
	public List<E> findAll() {
		...
		try {
			...
			BeanListHandler<E> bh = new BeanListHandler<E>((Class<? extends E>) ScheduleEntity.class);
	...
	public Long countAfterTime(Date time) {
		...
		try {
			...
			String sql = "select count(id) from t_schedule ";
			sql += " where status = 1";
			sql += " and updateTime > ?";
	...
	public Integer findMaxId() {
		...
		try {
			...
			String sql = "select max(id) from t_schedule ";
			sql += " where status = 1";
	...
	public List<Integer> findAllIds() {
		...
		try {
			...
			String sql = "select id from t_schedule ";
			sql += " where status = 1";
